  ...
  return (
    <div className='flex-0-0-auto lg:mr-4'>
      <Dropdown position='left' isDropdownFilter={ true }>
        <BaseButton iconLeft='filter' title='Thêm điều kiện lọc' iconRight='caret-down' className='btn-primary' />
        <FilterContainer>
          <Tabs forceRenderTabPanel={ true } selectedIndex={ tabIndex }
            ...
            <TabPanel>
              <div className="px-4 pb-2 flex k-flex-wrap">
                <div className="w-full md:w-1/2 md:pr-2">
                  <FilterDate filterParams={ leadFilterParamState } filterKey='filterDate' title='Ngày nhận Lead' />
                </div>
                <div className="w-full md:w-1/2 md:pl-2">
                  <FilterDropdown data={ arrEmployeeStatus } filterParams={ leadFilterParamState }
                    filterKey='employeeStatus' title='Trạng thái phụ trách'
                    animate={ false } filterable={ false } />
                </div>
                <div className="w-full">
                  <FilterMultiselect data={ employees } filterParams={ leadFilterParamState } filterKey='employees'
                    animate={ false } title='Nhân viên phụ trách' placeholder='Chọn nhân viên phụ trách'/>
                </div>
              </div>
            </TabPanel>
          </Tabs>
