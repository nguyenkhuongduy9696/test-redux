...
export const leadColumnTableState = atom({
  ...
  default: [
    ...
    { field: 'code', title: 'Mã Lead', minWidth: 150, isShow: true },
    { field: 'name', title: 'Tên Lead', minWidth: 200, isShow: true },
    { field: 'birthday', title: 'Ngày sinh', minWidth: 150, isShow: true },
    { field: 'mobile', title: 'Số điện thoại', minWidth: 150, isShow: true },
    ...
    { field: 'categories', title: 'Nhóm Lead', minWidth: 250, isShow: true },
    { field: 'resources', title: 'Nguồn Lead', minWidth: 250, isShow: true },
